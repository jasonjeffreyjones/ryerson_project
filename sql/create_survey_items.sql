...
CREATE TABLE survey_items (
  ...
  current_community_score DECIMAL(10,3) NOT NULL DEFAULT 1500.000 COMMENT 'Purpose: current community Elo score calculated from Item Bakeoff results.',
  ...
  KEY idx_survey_items_community_score (current_community_score),
  KEY idx_survey_items_tier_score (current_tier, current_community_score),
